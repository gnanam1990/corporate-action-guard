...
**Recorded at:** Module 00 completion, 2026-09-03.
**Repository state at this point:** documentation only. No code, no dependencies, no
deployments.
...
**Pre-window implementation risk:** this repository is being built before 17 September
2026. If OKX requires that all implementation occur inside the window, this work counts as
