...
| Rebuildable projections                           | REUSABLE_WITH_CHANGE | `packages/db/src/projections.ts`. Needs Base projections: assets, multiplier epochs, source health, cases, positions, conformance, preflight.                                                  |
